...
import { MapPin, Mail, Send, HelpCircle, ChevronDown, ChevronUp } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-12 gap-12">
            ...
            <div className="lg:col-span-7 space-y-10">
                ...
                <div className="bg-white p-8 md:p-10 rounded-2xl shadow-lg border border-gray-100">
                    ...
                    {submitted ? (
                        <div className="flex flex-col items-center justify-center text-center py-10 bg-green-50 rounded-xl">
                        ...
                        <div className="grid md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    id="name"
                                    required
                                    className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue outline-none transition-all"
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                required
                                rows={6}
                                className="w-full px-4 py-3 rounded-lg border border-gray-200 bg-gray-50 focus:bg-white focus:ring-2 focus:ring-brand-blue/20 focus:border-brand-blue outline-none transition-all resize-none"
                        ...
                        <button
                            type="submit"
                            className="w-full bg-brand-indigo text-white font-bold py-4 rounded-lg hover:bg-brand-blue transition-all shadow-md hover:shadow-lg transform hover:-translate-y-0.5"
                        >
                            Send Message
                        </button>
                        </form>
